        ...
        if (str_contains($messageLow, "top") || str_contains($messageLow, "ranking")) {
            ...
            if ($data && isset($data['results'])) {
                ...
                foreach ($data['results'] as $index => $game) {
                    ...
                    $response .= "<table style='width:100%; border-collapse:collapse; margin-bottom:12px; background: rgba(255,255,255,0.05); border-radius: 8px;'>";
                    $response .= "<tr><td style='font-weight:bold; color:#a685ff; padding: 5px;'>" . ($index + 1) . ". $gName</td></tr>";
